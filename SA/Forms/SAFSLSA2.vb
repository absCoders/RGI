...
#Region "Custom Methods"
    Sub Create_SATCSLS1()
        ...
        If Absx1.txtFor("CUST_CODE").Text = "" And Absx1.txtFor("SREP_CODE").Text = "" Then
            ...
            End If
            ASCMAIN1.sql = "Insert into " & SATCSLS1 & " (STYLE_CODE,COLOR_CODE,STYLE_COLOR_STATUS, STYLE_DESC,STYLE_STATUS,VEND_CODE,FACTORY_CODE,STYLE_UOM,STYLE_CLASS_CODE,CARTON_PACK_QTY,COLOR_DESC,PO_COST) " _
