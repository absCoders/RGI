...
#Region "Instantiate Class"
    ...
    Private Sub InitializeFormatting()
        ...
        Else
            ...
            tblEXCEL.Rows.Add({"Invoices", 24, "COMM_RATE", "2", 12, "Comm Rate", ""})
            tblEXCEL.Rows.Add({"Invoices", 25, "VEND_ID", "S", 10, "Vendor ID", ""})
            tblEXCEL.Rows.Add({"Invoices", 26, "VEND_CODE", "S", 12, "Vendor", ""})
            tblEXCEL.Rows.Add({"Invoices", 27, "PORT_CODE", "S", 12, "Port Code", ""})
            tblEXCEL.Rows.Add({"Invoices", 28, "PORT_NAME", "S", 12, "Port Name", ""})
            tblEXCEL.Rows.Add({"Invoices", 29, "LAST_PORT", "S", 12, "Last Port", ""})
            tblEXCEL.Rows.Add({"Invoices", 30, "COUNTRY_NAME", "S", 10, "Country", ""})
            tblEXCEL.Rows.Add({"Invoices", 31, "ORDR_SHIP_DATE", "D", 10, "Ship Date", ""})
            tblEXCEL.Rows.Add({"Invoices", 32, "ORDR_CANCEL_DATE", "D", 10, "Cancel Date", ""})
