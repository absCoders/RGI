    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With dst
            ...
            With SQL
                ...
                .AppendLine("SUM(NVL(DECODE(WHSE_CODE,'US',0,WHSE_QTY_PICK),0)) AS PICK,")
                .AppendLine("(SUM(NVL(WHSE_QTY_ON_HAND,0)) - SUM(NVL(DECODE(WHSE_CODE,'US',0,WHSE_QTY_PICK),0))) AS OTS,")
                ...
                .AppendLine("((SUM(NVL(WHSE_QTY_ON_HAND,0)) - SUM(NVL(DECODE(WHSE_CODE,'US',0,WHSE_QTY_PICK),0))) + SUM(NVL(WHSE_QTY_TRAN,0)) + SUM(NVL(WHSE_QTY_ON_ORDER,0)) - SUM(NVL(WHSE_QTY_OPEN,0))) AS OTS_WIP")
...
#Region "Custom Methods"
    Sub Create_SATCSLS1()
        ...
        If Absx1.txtFor("CUST_CODE").Text = "" And Absx1.txtFor("SREP_CODE").Text = "" Then
            ...
            S.AppendLine(String.Format("SUM(DECODE(WHSE_CODE,'{0}',(NVL(WHSE_QTY_ON_HAND,0) + (NVL(WHSE_QTY_ON_ORDER,0) - NVL(WHSE_QTY_TRAN,0)) - (NVL(WHSE_QTY_OPEN,0) + NVL(DECODE(WHSE_CODE,'US',0,WHSE_QTY_PICK),0))),0)) AS FUT_QTY_WHSE1,", Absx1.txtFor("WHSE_CODE1").Text))
            S.AppendLine(String.Format("SUM(DECODE(WHSE_CODE,'{0}',(NVL(WHSE_QTY_ON_HAND,0) + (NVL(WHSE_QTY_ON_ORDER,0) - NVL(WHSE_QTY_TRAN,0)) - (NVL(WHSE_QTY_OPEN,0) + NVL(DECODE(WHSE_CODE,'US',0,WHSE_QTY_PICK),0))),0)) AS FUT_QTY_WHSE2,", Absx1.txtFor("WHSE_CODE2").Text))
            S.AppendLine("SUM(NVL(WHSE_QTY_ON_HAND,0) + (NVL(WHSE_QTY_ON_ORDER,0) - NVL(WHSE_QTY_TRAN,0)) - (NVL(WHSE_QTY_OPEN,0) + NVL(DECODE(WHSE_CODE,'US',0,WHSE_QTY_PICK),0))) as FUT_QTY_TOT")
        ...
        If chkShow0Sales.Checked Then
            With SQL
                ...
                .AppendLine("SUM (NVL(WHSE_QTY_ON_HAND,0)+NVL(WHSE_QTY_ON_ORDER,0)+NVL(WHSE_QTY_TRAN,0)-NVL(WHSE_QTY_OPEN,0)-NVL(DECODE(S2.WHSE_CODE,'US',0,WHSE_QTY_PICK),0)) FUT_QTY,")
                .AppendLine("SUM (DECODE(S2.WHSE_CODE,'" & Absx1.txtFor("WHSE_CODE1").Text & "',NVL(WHSE_QTY_ON_HAND,0)+NVL(WHSE_QTY_ON_ORDER,0)+NVL(WHSE_QTY_TRAN,0)-NVL(WHSE_QTY_OPEN,0)-NVL(DECODE(S2.WHSE_CODE,'US',0,WHSE_QTY_PICK),0),0)) AS FUT_QTY_WHSE1,")
                .AppendLine("SUM (DECODE(S2.WHSE_CODE,'" & Absx1.txtFor("WHSE_CODE2").Text & "',NVL(WHSE_QTY_ON_HAND,0)+NVL(WHSE_QTY_ON_ORDER,0)+NVL(WHSE_QTY_TRAN,0)-NVL(WHSE_QTY_OPEN,0)-NVL(DECODE(S2.WHSE_CODE,'US',0,WHSE_QTY_PICK),0),0)) AS FUT_QTY_WHSE2,")
...
#End Region
    ...
    Private Function MakesqlSATCSLS1() As String
        ...
        If chkCreditsOnly.Checked Then
            ...
            Retval.AppendLine(") X")
            Retval.AppendLine(", (Select STYLE_CODE, COLOR_CODE")
            Retval.AppendLine(", SUM (NVL(WHSE_QTY_ON_HAND,0)+NVL(WHSE_QTY_ON_ORDER,0)+NVL(WHSE_QTY_TRAN,0)-NVL(WHSE_QTY_OPEN,0)-NVL(DECODE(WHSE_CODE,'US',0,WHSE_QTY_PICK),0)) FUT_QTY")
            Retval.AppendLine(", SUM (DECODE(WHSE_CODE,'WHSE1',NVL(WHSE_QTY_ON_HAND,0)+NVL(WHSE_QTY_ON_ORDER,0)+NVL(WHSE_QTY_TRAN,0)-NVL(WHSE_QTY_OPEN,0)-NVL(DECODE(WHSE_CODE,'US',0,WHSE_QTY_PICK),0),0)) FUT_QTY_WHSE1")
            Retval.AppendLine(", SUM (DECODE(WHSE_CODE,'WHSE2',NVL(WHSE_QTY_ON_HAND,0)+NVL(WHSE_QTY_ON_ORDER,0)+NVL(WHSE_QTY_TRAN,0)-NVL(WHSE_QTY_OPEN,0)-NVL(DECODE(WHSE_CODE,'US',0,WHSE_QTY_PICK),0),0)) FUT_QTY_WHSE2")
