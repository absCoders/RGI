Public Class SORSORD1
    ...
    Protected Overrides Sub Build_Workfile()
        ...
        Dim sqlO = "Select SOTORDR0.CUST_CODE, SOTORDR0.GROUP_SEQ, SOTORDR2.STYLE_CODE, SOTORDR2.COLOR_CODE" & vbCrLf _
            & ", DECODE (SOTORDR1.CUST_CODE, 'WALMART', NULL" & vbCrLf _
            & ", DECODE (SOTORDR1.CUST_CODE, 'KMART', NULL" & vbCrLf _
            & ", DECODE (SOTORDR1.CUST_CODE, 'SEARS', NULL, SOTORDR2.RANGE_STYLE_CODE))) RANGE_STYLE_CODE" & vbCrLf _
            ...
            & ", DECODE (SOTORDR1.CUST_CODE, 'WALMART', NULL" & vbCrLf _
            & ", DECODE (SOTORDR1.CUST_CODE, 'KMART', NULL" & vbCrLf _
            & ", DECODE (SOTORDR1.CUST_CODE, 'SEARS', NULL, SOTORDR2.RANGE_STYLE_CODE)))" & vbCrLf _
