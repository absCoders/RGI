...
#End Region
    ...
    Protected Overrides Sub Build_Workfile()
        Using New ScopeTimer("Build_Workfile")
    ...
    ByVal ParamArray parms() As Object) As ASCBASE1
        Using New ScopeTimer("Prepare_dst")
            ...
            sqlSOTINVH2 = "Select SOTINVH2.*,SOTINVH1.PICK_NO,SOTINVH1.ORDR_NO,SOTINVH1.SHIP_BOL_NO,SOTINVH1.SREP_CODE" _
                ...
                & " where SOTINVH2.INV_TYPE = SOTINVH1.INV_TYPE and SOTINVH2.INV_NO = SOTINVH1.INV_NO" _
                & IIf(consolidated_invoice, " and SOTINVH1.INV_NO_CONS is null", "")
            ...
            With dst
                ...
                ASCMAIN1.sql = "Select SOTORDR2.*, '0' INV_UOM
                                from SOTORDR2
                                where SOTORDR2.ORDR_NO in (Select Distinct ORDR_NO from " & SOTINVP1 & ")"
    ...
    Public Overrides Sub Fill_Records_RPT(ByVal ParamArray parms() As Object)
        Using New ScopeTimer("Fill_Records_RPT")
            Dim sqlw As String = ""
            ...
            If parms.Length > 0 Then
                ...
                End If
                Using New ScopeTimer("truncate INV Tables")
                ...
                End Using
                Using New ScopeTimer("Section A")
                    ...
                    End If
                End Using
                Using New ScopeTimer("Section B")
            ...
            Using New ScopeTimer("Section C")
            ...
            End Using
            Using New ScopeTimer("Section D")
                If pro_forma Then
                ...
                End If
                Using New ScopeTimer("Section D VH1")
                    For Each rowSOTINVH1 As DataRow In dst.Tables("SOTINVH1").Select("")
                    ...
                    Next
                End Using
                Using New ScopeTimer("Section D  VH2")
                    ...
                    Next
                End Using
                Using New ScopeTimer("Section D  VHM")
            ...
            End Using
                ...
                Using New ScopeTimer("Section E")
            ...
            Using New ScopeTimer("Section F")
    ...
    Sub Prepare_Invoice_Header(sqlw As String)
        Using New ScopeTimer("Prepare_Invoice_Header")
    ...
    Sub Create_Consolidated_Invoice()
        Using New ScopeTimer("Create_Consolidated_Invoice")
            '  If Absx1.chkFor("CHKCONS_INV").Checked Then
            ASCMAIN1.Progress("Consolidating Invoices")
            Using New ScopeTimer("Delete Non Cosolidated details")
            ...
            Using New ScopeTimer("Create Cosolidated details")
...
Public Class ScopeTimer
    ...
    Private Shared CallDepth As Integer = 0
    ...
    Public Sub New(name As String)
        ...
        _start = DateTime.Now
        CallDepth += 1
        Debug.WriteLine($"{New String(" "c, (CallDepth - 1) * 2)}Enter {_name} @ {_start}")
    End Sub

    Public Sub Dispose() Implements IDisposable.Dispose
        Dim elapsed = DateTime.Now - _start
        Debug.WriteLine($"{New String(" "c, (CallDepth - 1) * 2)}Exit  {_name} ({elapsed.TotalMilliseconds} ms)")
        CallDepth -= 1
    End Sub
End Class