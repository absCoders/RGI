...
#End Region
    ...
    Private Function Prepare_Sales_Invoices(
        ...
        SN.AppendLine("SOTINVH1.INV_SALES, SOTINVH1.INV_FREIGHT,  SOTINVH1.INV_MISC_CHG,  SOTINVH1.INV_TOTAL_AMOUNT,")
        ...
        S.AppendLine("TOTAL_SALES, INV_SALES, INV_FREIGHT, INV_MISC_CHG, INV_TOTAL_AMOUNT,")
