...
#Region "ABS Standard Routines" ' These Routines should be found in all Forms which Launch from the Menu.
    ...
    Private Function Generate_Excel_WPICS() As String
        ...
        oSheet.Range($"A{r}:N{r}").Value = "Effective Immediately: A temporary 25% surcharge now applies to all warehouse shipments; future adjustments may occur."
...
#End Region
    ...
    Function Generate_Excel() As String
        ...
        rng.Value = "Effective Immediately: A temporary 25% surcharge now applies to all warehouse shipments; future adjustments may occur."
        rng.BorderAround(Microsoft.Office.Interop.Excel.XlLineStyle.xlContinuous, Microsoft.Office.Interop.Excel.XlBorderWeight.xlThin, Microsoft.Office.Interop.Excel.XlColorIndex.xlColorIndexAutomatic)
        rng.Font.Bold = True
