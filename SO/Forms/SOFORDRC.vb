...
#Region "Remote Service Calls"
    ...
    Function VerifyControls() As String
        Dim iResult As String = ""
        Dim Controls As String() = {"CUST_CREDIT_CARD_NO", _
                                    "CUST_CREDIT_CARD_VER_CODE", _
                                    "CUST_CREDIT_CARD_NAME", _
                                    "CUST_CREDIT_CARD_ADDR1", _
                                    "CUST_CREDIT_CARD_CITY", _
                                    "CUST_CREDIT_CARD_STATE", _
