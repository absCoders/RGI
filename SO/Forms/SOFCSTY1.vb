...
#Region "ABS Standard Routines" ' These Routines should be found in all Forms which Launch from the Menu.
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If ASCMAIN1.CLIENT = "VAN" Then
            With UltraExplorerBar1.Groups("Special Functions")
                .Visible = False
                With .Items.Add("Update Cust/Style/Excel")
                    .Text = .Key
                End With
            End With
        End If
    ...
    Sub Proceed(ByVal eItemKey As String)
        ...
        Select Case eItemKey
            ...
            Case "Update Cust/Style/Excel"
                Customer_Style_Excel()
                Mode_Settings(False)
    ...
    Sub Customer_Style_Excel()
        ...
        If FILENAME <> "" Then
                    ...
                    If STYLE_CODE <> "" Then
                        ...
                        If rowSOTCSTY1 IsNot Nothing Then
                            If Val(CUST_PRICE) <> Val(rowSOTCSTY1.Item("CUST_PRICE") & "") Or (STYLE_CODE <> rowSOTCSTY1.Item("STYLE_CODE") & "") Or (COLOR_CODE <> rowSOTCSTY1.Item("COLOR_CODE") & "") Then
                                ...
                                If Val(CUST_PRICE) <> 0 Then
                                    rowSOTCSTY1.Item("CUST_PRICE") = Val(CUST_PRICE)
                                End If
                            End If

                        Else
                            ' new style add ictstyl1, add new 
                            rowSOTCSTY1 = dst.Tables("SOTCSTY1").NewRow
                            With rowSOTCSTY1
            ...
            If ERROR_CODEs.Count <> 0 Then
                ...
                If MsgBox("Are you sure you want to Update all New Styles and Price changed Styles  ",
