Public Class EDC855O1
    ...
    Public Shared Sub Add_EDT855O2(ByVal clsASCBASE1 As ASCBASE1, _
        ...
        With rowEDT855O2
            If ASCMAIN1.CLIENT = "RGI" Then
                ASCMAIN1.sql = "Select MAX(SOTORDR2.ORDR_UNIT_PRICE * nvl(SOTORDR2.SET_QTY,1)) ORDR_UNIT_PRICE, SUM(SOTORDR2.ORDR_QTY_OPEN / nvl(SOTORDR2.SET_QTY,1)) ORDR_QTY_OPEN, SUM(SOTORDR2.ORDR_QTY_PICK / nvl(SOTORDR2.SET_QTY,1)) ORDR_QTY_PICK, SUM(SOTORDR2.ORDR_QTY_CANC / nvl(SOTORDR2.SET_QTY,1)) ORDR_QTY_CANC " _
