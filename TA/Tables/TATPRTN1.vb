        ...
        If ASCMAIN1.DBS_SERVER = "NYA" Or ASCMAIN1.DBS_COMPANY = "NYA" Then
            With dst
                ...
                ASCMAIN1.sql = "Select 'NYAG' COMPANY, ICTSTYL1.SALES_DIVISION_CODE, ICTSEAS1.SEASON_TYPE, ICTSEAS1.SEASON_YEAR" _
                    ...
                    & " , ICTSTYL1.CARTON_PACK_QTY NYAGUNITSCASE, ICTSTYL1.INNER_PACK_QTY NYAGUNITSINNER, ICTSTYC1.UPC_CODE_INNER NYAGUPCINNER,DGJPOCOST.STYLE_CODE STYLE_CODE1, DGJPOCOST.VEND_CODE VEND_CODE1, DGJPOCOST.PO_COST,ICTSTYL1.INIT_DATE" _
