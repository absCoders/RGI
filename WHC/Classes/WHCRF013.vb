Public Class WHCRF013
    ...
    Sub New(ByVal g As GunEnvironment)
        ...
        AppStates.Add("MODE", "Receiving Mode|Carton|Receiver|EXIT|") 'Buttons
        ...
        Else
            Select Case AppState
                ...
                Case "SCAN_SHPMT"
                    ...
                    Fill_Records("POTSHIP2", New String() {PO_SHIPMENT_NO, CONTAINER_NO}, True)
                    ...
                    Else
                        ...
                        Else
                            If CheckResponse.ContainsKey("STYLE_CODE") Then
                                ...
                                If Mode = "Carton" Then
                                    CreateResponse("", "R", "UPC Not found Error")
                                Else
    ...
    Function GetLocation(ByVal Style As String, ByVal Color As String) As String
        ...
        ASCMAIN1.sql = "Select * from WHTLOCB1 " & vbCrLf _
            ...
            & "     and WHSE_CODE = '" & G.WHSE_CODE & "'" & vbCrLf _
    ...
    Sub Update_Record()
        ...
        If Mode = "Two Step" Or Mode = "Receiver" Or Mode = "Carton" Then
            NEW_LOCATION = RecLoc
