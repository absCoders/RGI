...
#Region "ABS Standard Routines" ' These Routines should be found in all Forms which Launch from the Menu.
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        With dst
            ...
            SQLSB.AppendLine("C1.CUST_SALES_HOLD,")
    ...
    Private Sub FillExtraCustomers()
        If chkOtherPending.Checked Then
            ...
            s.AppendLine($"FROM ARTOPEN1 O1, ARTCUST1 C1, {TEMPX} TT")
            s.AppendLine("WHERE O1.CUST_CODE (+) = C1.CUST_CODE")
            s.AppendLine("AND C1.CUST_CODE = TT.CUST_CODE")
            s.AppendLine("GROUP BY C1.CUST_CODE, C1.CUST_NAME, C1.SREP_CODE, C1.CUST_CREDIT_HOLD, C1.CUST_SALES_HOLD, C1.CUST_STATE, NVL(C1.POST_CODE,'REG'), TT.ORDS_RELD, TT.ORDS_PEND, C1.CUST_CREDIT_LIMIT")
