        ...
        For Each DIST_TYPE As String In New String() {"CASH", "AR", "DISC", "WOFF", "DED", "CB", "OA", "GL", "FX"}
            ...
            Select Case DIST_TYPE
                ...
                Case "DISC"
                    ...
                    Dim sql2 As String = ", ARTPYMT2.PYMT_BATCH_LNO, NVL(ARTPYMT3.CUST_CODE_SO, ARTPYMT2.CUST_CODE) DETL_CVX_NO, ARTPYMT3.INV_DATE DETL_CVX_REF_DATE,ARTPYMT3. INV_CUST_PO DETL_CVX_REF_NO, 'Discount' DETL_DESC, 'C' DETL_CVX_TYPE"
                ...
                Case "WOFF"
                    Dim sql1 As String = "ARTPYMT1.OPS_YYYYPP, ARTPYMT1.PYMT_BATCH_DATE" & BY_PYMT_BATCH_NO & ", ARTREAS1.ACCT_CODE, SOTCHAN1.SEG2_CODE, ARTREAS1.SEG3_CODE, ARTREAS1.SEG4_CODE"
                    Dim sql2 As String = ", ARTPYMT2.PYMT_BATCH_LNO,  NVL(ARTPYMT3.CUST_CODE_SO, ARTPYMT2.CUST_CODE) DETL_CVX_NO, ARTPYMT3.INV_DATE DETL_CVX_REF_DATE, ARTPYMT3.INV_CUST_PO DETL_CVX_REF_NO, 'Deduction' DETL_DESC, 'C' DETL_CVX_TYPE"
                ...
                Case "DED"
                    ...
                    Dim sql2 As String = ", ARTPYMT2.PYMT_BATCH_LNO,  NVL(ARTPYMT5.CUST_CODE_SO, ARTPYMT2.CUST_CODE) DETL_CVX_NO, ARTPYMT2.CUST_PYMT_REF_DATE DETL_CVX_REF_DATE, ARTPYMT5.CUST_REFERENCE DETL_CVX_REF_NO, 'Deduction: ' || ARTPYMT5.REASON_CODE || ':' || ARTPYMT5.GL_DIST_COMMENT DETL_DESC, 'C' DETL_CVX_TYPE"
                ...
                Case "CB"
                    ...
                    Dim sql1 As String = "ARTPYMT1.OPS_YYYYPP, ARTPYMT1.PYMT_BATCH_DATE" & BY_PYMT_BATCH_NO & ", ARTPOST1.ACCT_CODE, ARTPOST1.SEG2_CODE, ARTPOST1.SEG3_CODE, ARTPOST1.SEG4_CODE"
                    Dim sql2 As String = ", ARTPYMT2.PYMT_BATCH_LNO,  NVL(ARTPYMT5.CUST_CODE_SO, ARTPYMT2.CUST_CODE) DETL_CVX_NO, ARTPYMT2.CUST_PYMT_REF_DATE DETL_CVX_REF_DATE, ARTPYMT5.CUST_REFERENCE DETL_CVX_REF_NO, 'Chargeback: ' || ARTPYMT5.REASON_CODE || ':' || ARTPYMT5.GL_DIST_COMMENT DETL_DESC, 'C' DETL_CVX_TYPE"
                ...
                Case "OA"
                    ...
                    Dim sql1 As String = "ARTPYMT1.OPS_YYYYPP, ARTPYMT1.PYMT_BATCH_DATE" & BY_PYMT_BATCH_NO & ", ARTPOST1.ACCT_CODE, ARTPOST1.SEG2_CODE, ARTPOST1.SEG3_CODE, ARTPOST1.SEG4_CODE"
                    Dim sql2 As String = ", ARTPYMT2.PYMT_BATCH_LNO,  NVL(ARTPYMT5.CUST_CODE_SO, ARTPYMT2.CUST_CODE) DETL_CVX_NO, ARTPYMT2.CUST_PYMT_REF_DATE DETL_CVX_REF_DATE, ARTPYMT5.CUST_REFERENCE DETL_CVX_REF_NO, 'On/Acct' DETL_DESC, 'C' DETL_CVX_TYPE"
