...
#Region "Initialization"
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.ParentForm IsNot Nothing Then
            Parent_Form = DirectCast(Me.ParentForm, ASFBASE1)
        End If
        If Parent_Form IsNot Nothing Then
            ...
            If ASCMAIN1.USER_ID <> "" Then
                With grdSetup.DisplayLayout.Bands(0)
                    .Columns("COLUMN_CAPTION").CellAppearance.BackColor = Drawing.Color.Khaki ' SkyBlue
...
#Region "grdSetup"
    ...
    Sub Setup_grdSetup()
        If ASCMAIN1.USER_ID = "" Then Exit Sub
