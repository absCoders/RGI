    ...
    Private Sub Check_Open_POs()
                ...
                If VEND_CODE <> row.Item("VEND_CODE") & "" Then
                    ...
                    Else
                        dst.Tables("ICTCOSTV").Rows.Add _
                            (New String() {"Table", _
                                           row.Item("VEND_CODE"), _
                                           rowICTCOSTD.Item("PAYEE_COMMISSION"), _
                                           rowICTCOSTD.Item("PAYEE_INSPECTION"), _
                                           rowICTCOSTD.Item("PAYEE_OTHER")})
                    End If
                End If

                dst.Tables("ICTCOSTV").Rows.Add _
                    (New Object() {row.Item("PO_ORDER_NO"), _
                                   row.Item("VEND_CODE"), _
                                   row.Item("VEND_CODE_AGENT"), _
                                   row.Item("VEND_CODE_INSPECTION"), _
        ...
        Else
            MsgBox("There are No Open PO's with different Payees than those reflected in the Tables, as shown." _
                   & vbCrLf & vbCrLf _
                   & "If you have made changes, please make sure that you click Update to save those changes.", _
