    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With dst
            ASCMAIN1.sql = "Select ICTSTYL1.STYLE_CODE, ICTSTYL1.STYLE_DESC " & vbCrLf _
                & ",  ICTSTYL1.STYLE_MATL_DESC " & vbCrLf _
        ...
        For i As Integer = 1 To CC - 1
            ...
            If DC.ColumnName = "STYLE_CODE" Or DC.ColumnName = "STYLE_DESC" Then
            ...
            Try
               ...
               ' Dim PRDmax As Int32 = COLs - 3
                ...
                For Each row As DataRow In dt.Rows
                    ...
                    Else
                        Try
                            For I As Integer = 0 To 14 ' IS THIS CORRECT? DRC/ABS
