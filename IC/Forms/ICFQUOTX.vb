...
#Region "ABS Standard Routines" ' These Routines should be found in all Forms which Launch from the Menu.
        ...
        Select Case eItemKey
            ...
            Case "Excel"
                ...
                If fileName.Length = 0 Then
                    MsgBox("No Eligiable Printing Styles For This Selection", vbOKOnly, "Check Eligable Colors")
                Else
    ...
    Overrides Sub Mode_Settings(ByVal tf As Boolean, Optional ByVal MODE_description As String = "")
        ...
        With UltraExplorerBar1
            With .Groups("Screen Control")
                ...
                .Items("Clear Styles").Visible = False
    ...
    Sub Load_Record()
        ...
        If EntryMode = "N" Then
            ...
            rowICTQUOT1.Item("SOLDOUT_OPT") = "1"
...
#End Region
    ...
    Sub Create_Excel_WorkSheet(
        ...
        For Each row As DataRow In dst.Tables("ICTQUOT2").Select(sqlw, "STYLE_CODE_PLM") ' SEQ")
            ...
            If chkShowRetail.Checked And Val(row.Item("STYLE_RETAIL") & "") <> 0 Then worksheet.Cells(I + 2, CX + 4).Value = "Retail"
        ...
        worksheet.Cells(0, 2).Value = "Sold Out Quote"
...
#End Region
    ...
    Private Sub btnRefreshStyles_Click(sender As System.Object, e As System.EventArgs) Handles btnRefreshStyles.Click
        ...
        S.AppendLine("      WHERE S3.PO_SHIPMENT_NO = S2.PO_SHIPMENT_NO")
        S.AppendLine("      AND S3.PO_SHIPMENT_LNO = S2.PO_SHIPMENT_LNO")
        S.AppendLine("      AND S3.PO_ORDER_NO = P2.PO_ORDER_NO")
        S.AppendLine("      AND S3.PO_ORDER_LNO = P2.PO_ORDER_LNO")
        If chkRECDATES.Checked Then
            S.AppendLine(String.Format("      AND (NVL(S2.PO_DATE_RECEIVED,'01-JAN-1900') >= '{0}'", Format(dteRECDATEFR.DateTime, "dd-MMM-yyyy")))
            S.AppendLine(String.Format("      AND NVL(S2.PO_DATE_RECEIVED,'01-JAN-2900') <= '{0}')", Format(dteRECDATETO.DateTime, "dd-MMM-yyyy")))
        Else
            S.AppendLine("      AND P2.PO_ORDER_NO = ''")
        End If
        S.AppendLine("      GROUP BY P2.STYLE_CODE, P2.COLOR_CODE")
        S.AppendLine("      ORDER BY P2.STYLE_CODE, P2.COLOR_CODE")
        S.AppendLine("    ) P2")
        S.AppendLine("  WHERE ICTSTYL1.STYLE_CODE = ICTSTYC1.STYLE_CODE")
        S.AppendLine("  AND ICTSTYC1.STYLE_CODE = ICTSTAT2.STYLE_CODE (+)")
        ...
        If chkUseSoldOut.Checked Then
            ...
            End If
            S.Length = 0
            S.AppendLine("SELECT DISTINCT STYLE_CODE FROM")
            S.AppendLine(" (")
    ...
    Private Sub RemoveBadColors()
        For Each rowICTSTYC1 As DataRow In dst.Tables("ICTSTYC1").Select()
            ...
            Dim S As New System.Text.StringBuilder With {.Length = 0}
            S.AppendLine("SELECT COUNT(*) FROM")
            S.AppendLine(" (")
            S.AppendLine(String.Format("   SELECT * FROM {0}", LOAD_TEMP))
            S.AppendLine(" )")
            S.AppendLine(String.Format("WHERE STYLE_CODE = '{0}'", STYLE_CODE))
