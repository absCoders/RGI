...
Partial Class ICFNEWS4
    ...
    Private Sub InitializeComponent()
        ...
        Dim UltraGridColumn14 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("STYLE_CLASS_CODE", 0)
        Dim UltraGridColumn1 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("CARTON_LENGTH", 1)
        Dim UltraGridColumn2 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("CARTON_WIDTH", 2)
        Dim UltraGridColumn3 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("CARTON_HEIGHT", 3)
        Dim UltraGridColumn4 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("CARTON_WEIGHT", 4)
        Dim UltraGridColumn5 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("INNER_LENGTH", 5)
        Dim UltraGridColumn6 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("INNER_WIDTH", 6)
        Dim UltraGridColumn7 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("INNER_HEIGHt", 7)
        Dim UltraGridColumn8 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("INNER_WEIGHT", 8)
        Dim UltraGridColumn15 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("STYLE_LENGTH", 9)
        Dim UltraGridColumn16 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("STYLE_WIDTH", 10)
        Dim UltraGridColumn17 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("STYLE_HEIGHT", 11)
        Dim UltraGridColumn18 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("STYLE_WEIGHT", 12)
        ...
        Me.chkUPDATE_DIMS = New System.Windows.Forms.CheckBox()
        Me.chkUPDATE_MOQ = New System.Windows.Forms.CheckBox()
        Me.chkUPDATE_MATL = New System.Windows.Forms.CheckBox()
        ...
        UltraExplorerBarItem1.Text = "Load from Database"
        UltraExplorerBarItem2.Text = "Load From Spreadsheet"
        ...
        '
        Me.UltraExplorerBarContainerControl1.Controls.Add(Me.chkUPDATE_DIMS)
        Me.UltraExplorerBarContainerControl1.Controls.Add(Me.chkUPDATE_MOQ)
        Me.UltraExplorerBarContainerControl1.Controls.Add(Me.chkUPDATE_MATL)
        ...
        'chkUPDATE_DIMS
        '
        Me.chkUPDATE_DIMS.AutoSize = True
        Me.chkUPDATE_DIMS.Location = New System.Drawing.Point(3, 24)
        Me.chkUPDATE_DIMS.Name = "chkUPDATE_DIMS"
        Me.chkUPDATE_DIMS.Size = New System.Drawing.Size(151, 20)
        Me.chkUPDATE_DIMS.TabIndex = 174
        Me.chkUPDATE_DIMS.Text = "Update Dimensions"
        Me.chkUPDATE_DIMS.UseVisualStyleBackColor = True
        '
        'chkUPDATE_MOQ
        '
        Me.chkUPDATE_MOQ.AutoSize = True
        Me.chkUPDATE_MOQ.Location = New System.Drawing.Point(3, 50)
        Me.chkUPDATE_MOQ.Name = "chkUPDATE_MOQ"
        Me.chkUPDATE_MOQ.Size = New System.Drawing.Size(110, 20)
        Me.chkUPDATE_MOQ.TabIndex = 173
        Me.chkUPDATE_MOQ.Text = "Update MOQ"
        Me.chkUPDATE_MOQ.UseVisualStyleBackColor = True
        '
        'chkUPDATE_MATL
        '
        Me.chkUPDATE_MATL.AutoSize = True
        Me.chkUPDATE_MATL.Location = New System.Drawing.Point(3, 76)
        Me.chkUPDATE_MATL.Name = "chkUPDATE_MATL"
        Me.chkUPDATE_MATL.Size = New System.Drawing.Size(131, 20)
        Me.chkUPDATE_MATL.TabIndex = 172
        Me.chkUPDATE_MATL.Text = "Update Material"
        Me.chkUPDATE_MATL.UseVisualStyleBackColor = True
        '
        ...
        UltraGridColumn14.Header.Caption = "Class Code"
        UltraGridColumn14.Header.VisiblePosition = 0
        UltraGridColumn1.Header.Caption = "Carton Length (In)"
        UltraGridColumn1.Header.VisiblePosition = 1
        UltraGridColumn2.Header.Caption = "Carton Width (In)"
        UltraGridColumn2.Header.VisiblePosition = 2
        UltraGridColumn3.Header.Caption = "Carton Height (In)"
        UltraGridColumn3.Header.VisiblePosition = 3
        UltraGridColumn4.Header.Caption = "Carton Weight (Lbs)"
        UltraGridColumn4.Header.VisiblePosition = 4
        UltraGridColumn5.Header.Caption = "Inner Length (In)"
        UltraGridColumn5.Header.VisiblePosition = 5
        UltraGridColumn6.Header.Caption = "Inner Width (In)"
        UltraGridColumn6.Header.VisiblePosition = 6
        UltraGridColumn7.Header.Caption = "Inner Height (In)"
        UltraGridColumn7.Header.VisiblePosition = 7
        UltraGridColumn8.Header.Caption = "Inner Weight (Lbs)"
        UltraGridColumn8.Header.VisiblePosition = 8
        UltraGridColumn15.Header.Caption = "Style Length (In)"
        UltraGridColumn15.Header.VisiblePosition = 9
        UltraGridColumn16.Header.Caption = "Style Width (In)"
        UltraGridColumn16.Header.VisiblePosition = 10
        UltraGridColumn17.Header.Caption = "Style Height (In)"
        UltraGridColumn17.Header.VisiblePosition = 11
        UltraGridColumn18.Header.Caption = "Style Weight (Lbs)"
        UltraGridColumn18.Header.VisiblePosition = 12
        UltraGridBand1.Columns.AddRange(New Object() {UltraGridColumn14, UltraGridColumn1, UltraGridColumn2, UltraGridColumn3, UltraGridColumn4, UltraGridColumn5, UltraGridColumn6, UltraGridColumn7, UltraGridColumn8, UltraGridColumn15, UltraGridColumn16, UltraGridColumn17, UltraGridColumn18})
        ...
        Me.grdICTSTYLX.Size = New System.Drawing.Size(712, 538)
        Me.grdICTSTYLX.TabIndex = 111
        Me.grdICTSTYLX.Text = "Styles Worksheet"
        '
        ...
        'spl.Panel2
        '
        Me.spl.Panel2.Controls.Add(Me.grdICTSTYLX)
    ...
    Friend WithEvents chkUPDATE_DIMS As CheckBox
    Friend WithEvents chkUPDATE_MOQ As CheckBox
    Friend WithEvents chkUPDATE_MATL As CheckBox
End Class
