...
#Region "ABS Standard Routines" ' These Routines should be found in all Forms which Launch from the Menu.
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With dst
            ...
            ASCMAIN1.sql = SQL.ToString()
            Create_TDA(.Tables.Add, "ICTPROM2", "**", 0, True, "V", 3)
        ...
        Sort_grdColumns(grdICTPROM2, "STYLE_CODE, COLOR_CODE", False)
                    ...
                    Else
                        ...
                        If tblICTPROM2.Rows.Count > 0 Then
                            For Each rowICTPROM2 As DataRow In tblICTPROM2.Rows
                                ...
                                End If
                                ERR_MSG2.AppendLine(String.Format("{0} | {1} | {2} | {3}-{4}", PROMO_CTL_NO, SD, ED, STYLE_CODE, COLOR_CODE))
                            Next
                        Else
                            ...
                            rowICTPROM2.Item("COLOR_CODE") = COLOR_CODE
    ...
    Private Sub UploadSpreadsheet()
        ...
        If FirstRow > 0 Then
            ...
            For i As Int64 = FirstRow + 1 To LastRow
                ...
                Dim PROMO_STYLE_NOTES As String = UpsertData.Rows(i).Item(3).ToString.ToUpper
                ...
                Dim S_CNT As Int16 = Val(ASCDATA1.GetDataValue)

                If S_CNT = 0 Then
                    PROBLEM_STYLES.AppendLine(String.Format("{0}-{1} Is Not In The System.", STYLE_CODE, COLOR_CODE))
                    HAS_PROBLEM = True
                Else
                    SQLS.Length = 0
                ...
                If HAS_PROBLEM = False Then
                    ...
                    newICTPROM2.Item("COLOR_CODE") = COLOR_CODE
