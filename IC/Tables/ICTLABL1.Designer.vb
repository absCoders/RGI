...
Partial Class ICTLABL1
    ...
    Private Sub InitializeComponent()
        ...
        Me.UltraLabel1.Text = "Label Type"
        '
        'UltraTextEditor2
        '
        Me.Absx1.SetABSColumnName(Me.UltraTextEditor2, "LABEL_TYPE_DESC")
        ...
        'UltraTextEditor1
        '
        Me.Absx1.SetABSColumnName(Me.UltraTextEditor1, "LABEL_TYPE_CODE")
