...
#Region "ABS Standard Routines" ' These Routines should be found in all Forms which Launch from the Menu.
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With dst
            ASCMAIN1.sql = "Select * from EDT846T1 where EDI_TP_QUAL = :PARM1 and EDI_TP_ID = :PARM2"
            ...
            ASCMAIN1.sql = "Select EDT846T2.*, ICTSTAT2.WHSE_QTY_ON_HAND" _
                ...
                & " and ICTSTAT2.COLOR_CODE (+) = 'AST'" _
                & " and ICTSTAT2.WHSE_CODE (+) = '93'"
        ...
        grdEDT855T1.DataSource = dst.Tables("EDT846T1")
        grdEDT855.DataSource = dst.Tables("EDT846T2")

        Create_Summary(grdEDT855T1, "EDI_DOC_SEQ_NO", "Count")

        Create_Summary(grdEDT855, "EDI_DTL_SEQ", "Count")
        Create_Summary(grdEDT855, New String() {"EDI_ON_HAND_QTY", "EDI_ALLOCATED_QTY", "WHSE_QTY_ON_HAND", "VARIANCE"})
    ...
    Overrides Sub Mode_Settings(ByVal tf As Boolean, Optional ByVal MODE_description As String = "")
        ...
        grdEDT855T1.Visible = Not ScreenMode
    ...
    Sub Load_Record()
        ...
        ASCMAIN1.sql = "Select WHSE_CODE, STYLE_CODE, COLOR_CODE from ICTSTAT2 " _
            & " where WHSE_QTY_ON_HAND <> 0 and WHSE_CODE = '93' minus " _
            & " Select '93' WHSE_CODE, STYLE_CODE, 'AST' COLOR_CODE" _
            & " from EDT846T2 where EDI_DOC_SEQ_NO = '" & EDI_DOC_SEQ_NO & "'"
        ASCMAIN1.sql = "Select ICTSTAT2.*,ICTSTYL1.STYLE_DESC from ICTSTAT2,ICTSTYL1 where ICTSTYL1.STYLE_CODE = ICTSTAT2.STYLE_CODE and (ICTSTAT2.WHSE_CODE, ICTSTAT2.STYLE_CODE, ICTSTAT2.COLOR_CODE) in (" & ASCMAIN1.sql & ")"
...
#End Region
    ...
    Sub Load_EDT846T1()
        ...
        Sort_grdColumns(grdEDT855T1, "EDI_DOC_SEQ_NO".ToLower)
    End Sub

    Private Sub grdEDT846T1_DoubleClickRow(sender As Object, e As Infragistics.Win.UltraWinGrid.DoubleClickRowEventArgs) Handles grdEDT855T1.DoubleClickRow
