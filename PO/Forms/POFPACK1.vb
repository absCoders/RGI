...
#Region "ABS Standard Routines" ' These Routines should be found in all Forms which Launch from the Menu.
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Create_Summary(grdPOTPACK2, New String() {"TOTAL_CARTONS", "TOTAL_UNITS", "TOTAL_GRS_WGT", "TOTAL_NET_WGT"})
...
#Region "Popup Menus"
    ...
    Overrides Sub Load_Popup_Menus()
        ...
        Load_Popup_Menu(grdPOTPACK3, "B", "Add Line", "Copy Value to All Lines")
    End Sub
    ...
    Overrides Sub tlb_ToolClick(ByVal sender As System.Object, ByVal e As Infragistics.Win.UltraWinToolbars.ToolClickEventArgs)
        ...
        Select Case e.Tool.Key
            Case "Add Line"
                ...
                rowPOTPACK3_new.Item("PACK_LIST_SHEET_LNO") = PACK_LIST_SHEET_LNO_max + 1
...
#End Region
    ...
    Private Sub grdPOTPACK3_InitializeRow(sender As Object, e As InitializeRowEventArgs) Handles grdPOTPACK3.InitializeRow
        ...
        Dim CARTON_DIMENSIONS As String = e.Row.Cells.Item("CARTON_ID").Value & ""
