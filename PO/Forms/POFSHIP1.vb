...
#End Region
    ...
    Private Sub btnABSonly_Click(sender As System.Object, e As System.EventArgs) Handles btnABSonly.Click
        ...
        ASCMAIN1.sql = "SELECT PO_SHIPMENT_NO FROM POTSHIP1 WHERE PO_SHIPMENT_NO IN (" & vbCrLf _
            & "SELECT DISTINCT PO_SHIPMENT_NO FROM POTSHIP2 WHERE OPS_YYYYPP = '202412')" & vbCrLf _
            & "AND NVL(COST_COMPLETE,'0') = '0' And PO_SHIPMENT_NO Not In ('010733','011084','011085','011147','011204','011207','011225','011227','011397','011622')"
