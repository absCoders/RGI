...
Partial Class POTMESST
    ...
    Private Sub InitializeComponent()
        ...
        Me.UltraLabel1.Text = "Message Type"
        '
        'UltraTextEditor2
        '
        Me.Absx1.SetABSColumnName(Me.UltraTextEditor2, "PO_MESSAGE_TYPE_DESC")
        ...
        'UltraTextEditor1
        '
        Me.Absx1.SetABSColumnName(Me.UltraTextEditor1, "PO_MESSAGE_TYPE")
