...
#End Region
    ...
    Sub Create_Temp_Table(Initialize As Boolean)
        ...
        Dim sqlWHTLOCBX As String = $"Select X.*, 0 PICK, ' ' STYLE_DESC, WHTLOCBC.DATE_LAST_CYCLE_COUNT from {WHTLOCBC} WHTLOCBC, (
            ...
            FROM WHTLOCB1
            WHERE LOCATION_QTY <> 0 and LOCATION_CODE not like '99-%')
