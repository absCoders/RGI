...
#Region "ABS Standard Routines" ' These Routines should be found in all Forms which Launch from the Menu.
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With dst
            ...
            ASCMAIN1.sql = " Select NVL(SOTSHIP1.BILL_OF_LADING_NO, SOTSHIP1.SHIP_BOL_NO) BILL_OF_LADING_NO, WHTSHPC1.SHIP_DATE, WHTSHPC1.OPS_YYYYPP" _
                    & ",SOTSHIP1.FRT_TERMS, SOTINVH1.INV_NO, SOTINVH1.INV_DATE, SOTINVH1.CUST_CODE, ARTCUST1.CUST_NAME, WHTSHPC1.MASTER_TRACKING_NO" _
                    & " , NVL(SOTINVH1.INV_FREIGHT, 0) INV_FREIGHT" _
                    & " , SUM(NVL(WHTSHPC2.NET_CHARGE, 0)) NET_CHARGE" _
                    & " , SUM(NVL(WHTSHPCI.BILLED_CHARGE, 0)) BILLED_CHARGE" _
                    & " , SUM(NVL(WHTSHPC2.NET_CHARGE, 0)) - SUM(NVL(WHTSHPCI.BILLED_CHARGE, 0)) RATE_VARIANCE" _
                    & " , NVL(SOTINVH1.INV_FREIGHT, 0) - SUM(NVL(WHTSHPCI.BILLED_CHARGE, 0)) INVOICE_VARIANCE" _
                    & " FROM SOTSHIP1, SOTPICK1, SOTINVH1, WHTSHPC1, WHTSHPC2, WHTSHPCI, ARTCUST1" _
                    & " WHERE SOTSHIP1.SHIP_BOL_NO = SOTPICK1.SHIP_BOL_NO" _
                    & " AND WHTSHPC1.CARRIER_CODE = :PARM1" _
                    & " AND (SOTINVH1.ORDR_YYYYPP_UPDATED BETWEEN :PARM2 AND :PARM3 or WHTSHPCI.INVOICE_NUMBER = :PARM4)" _
                    & " AND SOTPICK1.INV_NO = SOTINVH1.INV_NO" _
                    & " AND SOTINVH1.CUST_CODE = ARTCUST1.CUST_CODE (+) " _
                    & " AND SOTSHIP1.SHIP_BOL_NO = WHTSHPC2.INV_BOL_NO " _
                    & " AND WHTSHPC1.SHIP_CNTL_NO (+) = WHTSHPC2.SHIP_CNTL_NO" _
                    & " AND WHTSHPC2.INV_NO (+) = SOTINVH1.INV_NO" _
                    & " AND WHTSHPC2.SHIP_CNTL_NO = WHTSHPCI.SHIP_CNTL_NO (+)" _
                    & " AND WHTSHPC2.SHIP_PACKAGE_NO = WHTSHPCI.SHIP_PACKAGE_NO (+)" _
                    & " AND NVL(WHTSHPC1.STATUS, 'P') = 'P'" _
                    & " GROUP BY NVL(SOTSHIP1.BILL_OF_LADING_NO, SOTSHIP1.SHIP_BOL_NO), WHTSHPC1.SHIP_DATE, WHTSHPC1.OPS_YYYYPP, SOTSHIP1.FRT_TERMS, SOTINVH1.INV_NO, SOTINVH1.INV_DATE, SOTINVH1.CUST_CODE, ARTCUST1.CUST_NAME, WHTSHPC1.MASTER_TRACKING_NO, NVL(SOTINVH1.INV_FREIGHT, 0)" _
                    & " HAVING NVL(INV_FREIGHT, 0) > 0 OR SUM(NVL(WHTSHPC2.NET_CHARGE, 0)) > 0 OR SUM(NVL(WHTSHPCI.BILLED_CHARGE, 0)) > 0"
