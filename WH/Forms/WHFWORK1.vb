...
#Region "ABS Standard Routines" ' These Routines should be found in all Forms which Launch from the Menu.
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'use this form and the work table for anything that needs a quick data gathering especially if scanning barcodes

        With dst

            ASCMAIN1.sql = "Select * from WHTWORK1"
            Create_TDA(.Tables.Add, "WHTWORK1", "**", 0, True, "", 0)

        End With

        grdWHTWORK1.DataSource = dst.Tables("WHTWORK1")
        Create_Summary(grdWHTWORK1, "UPC_CODE", "Count")

        For Each grd As UltraWinGrid.UltraGrid In New UltraWinGrid.UltraGrid() {grdWHTWORK1}
            With grd.DisplayLayout.Override
                .AllowAddNew = UltraWinGrid.AllowAddNew.Yes
                .AllowUpdate = DefaultableBoolean.True
                .AllowDelete = DefaultableBoolean.True
                .AddRowAppearance.BackColor = Drawing.Color.LightYellow ' Optional: visual cue
                .AddRowAppearance.ForeColor = Drawing.Color.Black
            End With
        Next

        With grdWHTWORK1.DisplayLayout.Bands(0)
...
#Region "Popup_Menus"
    ...
    Overrides Sub Load_Popup_Menus()
        'Load_Popup_Menu(grdWHTWORK1, "SSSBBBB", "Show Filter", "Show GroupBox", "Show Pins", "PO Inquiry", "Sales Order Inquiry", "Sales Reservation Inquiry", "email Work Order")
    End Sub
    ...
    Overrides Sub tlb_ToolClick(ByVal sender As System.Object, ByVal e As Infragistics.Win.UltraWinToolbars.ToolClickEventArgs)
        ...
        Select Case e.Tool.Key
            ...
            Case "email Work Order"
                ...
                Dim WO_REF_TYPE As String = grdWHTWORK1.ActiveRow.Cells("WO_REF_TYPE").Value
                Dim WO_REF_NO As String = grdWHTWORK1.ActiveRow.Cells("WO_REF_NO").Value
                Dim REFERENCE1 As String = grdWHTWORK1.ActiveRow.Cells("REFERENCE1").Value & ""
                Dim REFERENCE2 As String = grdWHTWORK1.ActiveRow.Cells("REFERENCE2").Value & ""
                Dim DATE1 As Date = grdWHTWORK1.ActiveRow.Cells("DATE1").Value & ""
                Dim DATE2 As Date = grdWHTWORK1.ActiveRow.Cells("DATE2").Value & ""
                Dim WO_NO As String = grdWHTWORK1.ActiveRow.Cells("WO_NO").Value
                Dim WO_DATE As Date = grdWHTWORK1.ActiveRow.Cells("WO_DATE").Value
                Dim WO_DUE As Date = grdWHTWORK1.ActiveRow.Cells("WO_DUE").Value
                ...
                Dim REF As String = ""
                Dim BODY As String = grdWHTWORK1.ActiveRow.Cells("WO_DESC").Value & vbCrLf & vbCrLf
        ...
        Select Case Absx1.GetABSColumnName(sender)
            Case "UPC_CODE"
                If e.KeyValue = Keys.Enter Then
                    Dim row As DataRow = dst.Tables("WHTWORK1").NewRow
                    row("UPC_CODE") = txtUPC_CODE.Value
                    dst.Tables("WHTWORK1").Rows.Add(row)
                    txtUPC_CODE.Value = ""
                End If
...
#End Region
    ...
    Sub Load_SOTWORK1()
        ...
        ASCMAIN1.sql = "Select * From WHTWORK1"
        Fill_Records("WHTWORK1", "", True, ASCMAIN1.sql)

        grdWHTWORK1.Rows.ExpandAll(True)

        Me.Cursor = Cursors.Default
        ASCMAIN1.Progress("")
    End Sub

    Private Sub grdWHTWORK1_DoubleClickRow(sender As Object, e As Infragistics.Win.UltraWinGrid.DoubleClickRowEventArgs) Handles grdWHTWORK1.DoubleClickRow
        'If grdWHTWORK1.ActiveRow IsNot Nothing Then
        '    If grdWHTWORK1.ActiveRow.IsDataRow Then
        '        Dim WO_REF_TYPE As String = grdWHTWORK1.ActiveRow.Cells("WO_REF_TYPE").Value
        '        Dim WO_REF_NO As String = grdWHTWORK1.ActiveRow.Cells("WO_REF_NO").Value
        '        Dim REFERENCE1 As String = grdWHTWORK1.ActiveRow.Cells("REFERENCE1").Value & ""
        '        Dim REFERENCE2 As String = grdWHTWORK1.ActiveRow.Cells("REFERENCE2").Value & ""
        ...
        '            Using F As New TAC.SOFWORK1(Me, WO_REF_TYPE, WO_REF_NO, False, REFERENCE1, REFERENCE2, DATE1, DATE2,
        ...
        '            Using F As New TAC.SOFWORK1(Me, "W", WO_NO, False, WO_REF_TYPE, WO_REF_NO, WO_DATE, WO_DUE,
        '                    "Work Order " & WO_NO)
        '                F.ShowDialog()
        '            End Using
    ...
    Private Sub grdSOTWORK1_InitializeLayout(sender As System.Object, e As Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs) Handles grdWHTWORK1.InitializeLayout

    End Sub

    Private Sub optUser_ValueChanged(sender As System.Object, e As System.EventArgs)
        If SELECTION_NO = 0 Then Exit Sub
        Load_SOTWORK1()
    End Sub

    Private Sub optStatus_ValueChanged(sender As System.Object, e As System.EventArgs)
        If SELECTION_NO = 0 Then Exit Sub
        Load_SOTWORK1()
    End Sub

    Private Sub optWO_REF_TYPE_ValueChanged(sender As System.Object, e As System.EventArgs)
        If SELECTION_NO = 0 Then Exit Sub
        Load_SOTWORK1()
    End Sub
